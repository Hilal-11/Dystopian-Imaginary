...
function FAQ() {
  return (
    <div className='my-10 lg:my-20 space-y-10'>
        <div className='mx-auto'>
             <h1 className='text-center lg:text-7xl text-4xl Inter-bold'>Frequently asked questions</h1>
            <p className='text-center text-lg Inter-medium px-3 lg:w-2/3 mx-auto'>We are here to help you with any questions you may have. If you don't find what you need, please contact us at Find Some quick answers to the most common questions.</p>
        </div>
    <div className='my-10 lg:my-20 w-full px-0 container mx-auto lg:max-w-[80%] Inter-medium space-y-4 grid lg:grid-cols-3 grid-cols-1 justify-between'>
